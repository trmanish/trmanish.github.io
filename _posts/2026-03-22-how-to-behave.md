...
<div align="center">
  <h1><strong>How to Behave</strong></h1>
</div>
...
<div style="text-align: center; font-size: 1.5em; padding: 15px; border-radius: 8px; background-color: #fcfcfc; border: 1px solid #eee; width: 80%; margin: 20px auto;">
    Human Behavior is very primed to follow Newton's Third Law of Motion: Every Action has an equal and Opposite Reaction.
</div>
...
1. Human Action of Others towards us.
2. Our own Human Action towards everyone else.
...
<div style="text-align: center; font-size: 1.5em; padding: 15px; border-radius: 8px; background-color: #fcfcfc; border: 1px solid #eee; width: 80%; margin: 20px auto;">
    Your actions define your Karma. Their actions define their Karma.
</div>
